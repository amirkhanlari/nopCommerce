...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class OrdersController : BaseApiController
    {
        ...
        public IActionResult DeleteOrder(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteOrder", _localizationService.GetResource("ActivityLog.DeleteOrder"), orderToDelete);
        ...
        public IActionResult UpdateOrder([ModelBinder(typeof(JsonModelBinder<OrderDto>))] Delta<OrderDto> orderDelta)
        {
            ...
            _customerActivityService.InsertActivity("UpdateOrder",
                 _localizationService.GetResource("ActivityLog.UpdateOrder"), currentOrder);
