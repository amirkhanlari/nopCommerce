...
namespace Nop.Plugin.Widgets.CarouselSlider.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// {0} : picture id
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop.plugins.widgets.CarouselSlider.pictureurl-{0}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.CarouselSlider";
