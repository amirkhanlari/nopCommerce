    ...
    (function ($, undefined) {
        ...
        var Calendar = Widget.extend({
            ...
            options: {
                name: 'Calendar',
                value: null,
                min: (kendo.getCulture().name == "fa-IR" ? new DATE(1278, 11, 1) : new DATE(1900, 0, 1)),
                max: (kendo.getCulture().name == "fa-IR" ? new DATE(1478, 11, 1) : new DATE(2099, 11, 31)),
                dates: [],
                disableDates: null,
                url: '',
                culture: '',
            ...
            _validateValue: function (value) {
                ...
                if (value === null) {
                    if (kendo.getCulture().name == "fa-IR" || options.culture == "fa-IR"){
            ...
            _nextNavigatable: function (currentValue, value) {
                var that = this, disabled = true, view = that._view, min = that.options.min, max = that.options.max, isDisabled = that.options.disableDates, 
                navigatableDate = (kendo.getCulture().name == "fa-IR" || that.options.culture == "fa-IR") ? new JalaliDate(currentValue.getTime()) : new Date(currentValue.getTime());
            ...
            _click: function (link) {
                ...
                currentValue = (kendo.getCulture().name == "fa-IR" || options.culture == "fa-IR") ? new JalaliDate(+that._current) : new Date(+that._current),
        ...
        var calendar = {
            ...
            firstVisibleDay: function (date, calendarInfo) {
                ...
                if (kendo.getCulture().name == "fa-IR") {
