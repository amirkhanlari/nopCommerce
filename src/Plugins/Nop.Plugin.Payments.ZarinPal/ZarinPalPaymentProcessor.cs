...
namespace Nop.Plugin.Payments.ZarinPal
{
    ...
    public class ZarinPalPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        {
            viewComponentName = "PaymentZarinPal";
        }
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            if (Status == 100)
            {
                _httpContextAccessor.HttpContext.Response.Redirect(GetZarinPalRedirect() + Authority);
            }
            else
            {
                _httpContextAccessor.HttpContext.Response.Redirect("HomePage");
            }
