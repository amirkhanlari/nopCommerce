...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class ShoppingCartItemsController : BaseApiController
    {
        ...
        public IActionResult DeleteShoppingCartItem(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteShoppingCartItem", _localizationService.GetResource("ActivityLog.DeleteShoppingCartItem"), shoppingCartItemForDelete);
